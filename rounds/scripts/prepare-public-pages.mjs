...
<p>Rounds is a medical student revision app from ${name}. Start with active recall, read a concise management answer, and return to the cards you need to practise.</p>
...
<p>Rounds is for education. It does not diagnose, treat or provide patient-specific advice. Check with a qualified clinician and local guidance before making medical decisions.</p>
...
<h2>Suggest a content correction</h2><p>Include the card title, the part that needs correcting and, when available, a reliable reference so the teaching content can be checked and updated.</p>
...
<p class="note">Updated 10 September 2026 · Rounds by ${name}</p>
...
<h2>Content downloads and this website</h2><p>The app requests public study content from Google Cloud Firestore. The support website is served by Firebase Hosting. Content requests do not include your answers, saved cards, cat name or study history. Normal network requests expose technical information such as your IP address to Google as the infrastructure provider.</p>
<p>See <a href="https://firebase.google.com/support/privacy">Firebase privacy and security information</a> and the <a href="https://policies.google.com/privacy">Google Privacy Policy</a> for information about Google’s handling of service data.</p>
